...
args["cmpName"] = "sina.mobile.tianqitongletv/com.sina.tianqitong.ui.main.MainTabActivity"
args["packageName"] = "sina.mobile.tianqitongletv"
args["caseName"] = "Tianqi_launch"
# ----------------------------------------------------------------------------------------------------
doQALaunchTime(args)